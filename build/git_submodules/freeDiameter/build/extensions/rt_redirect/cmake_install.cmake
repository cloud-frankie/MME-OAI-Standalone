# Install script for directory: /home/gcuba/openair-cn/build/git_submodules/freeDiameter/extensions/rt_redirect
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "freeDiameter-daemon")
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/freeDiameter" TYPE MODULE FILES "/home/gcuba/openair-cn/build/git_submodules/freeDiameter/build/extensions/rt_redirect.fdx")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/freeDiameter/rt_redirect.fdx" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/freeDiameter/rt_redirect.fdx")
